...
- [ ] 主角快速出场
- [ ] 卖点或危机可见
- [ ] 前 50 字有冲突/异常；前 100 字读者知道核心矛盾

### 小节推进
- [ ] 本节至少改变目标 / 风险 / 信息 / 关系 / 资源 / 身份 / 情绪立场七类状态之一；快节奏（番茄/爽文）应有可见事件或爽点，慢热/情感文才可只靠低压小变化达标，不强求每节高潮
- [ ] 不是水字数（删掉这节会损失哪项状态变化？答不出才需压缩）
...
- [ ] 对话符合人物身份（不同人说话方式不同）
- [ ] 情绪通过动作落地（不是直接说"他很难过"）
- [ ] 标题行以外没有写作元信息：不得出现 `第[一二三四五六七八九十百千万两0-9]+节|上一节|前一节|本节|前文|后文|伏笔|大纲|读者` 这类词；需要承接前文时改成角色能感知的事件锚点或相对时间；故事内真实阅读/讨论标题或真实读者身份语境除外
...
| 小节字数偏离目标 | **high** | 写作/大纲修复时先回到 小节大纲 补足计划内情节点，再展开；去AI味已有正文时不得新增剧情 |
...
| 对话条数 | 12-18条/千字 | <8条（缺交互）或>25条（碎片化） |
