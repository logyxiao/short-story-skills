...
> 本文件的旧语料范式若与 `story-constraints.md` 冲突，一律以后者为准，尤其是单一主角限知视角、禁用剧情、对话 ≤35% 与禁用字词。
...
| 平台 | 对话占比 | 功能分布 |
|------|----------|----------|
| 知乎盐言 | 25-32% 为安全区，硬上限 35% | 只保留试探、冲突、关系变化和关键信息；其余由主角叙述与动作后果承载 |
...
| 对话占正文≤35% | 每句对话推进剧情、关系或情绪；人物说话方式可区分 | 无功能闲聊、轮流解释剧情 |
...
**结尾三种黄金模式**：A. 主角亲眼见到反派后果；B. 开放式暗示；C. 仪式感收场。三种模式都不得跳出主角有限视角。

**重生文核心**：第一件事做"前世绝不会做的事"。

**灵魂/鬼视角**：仍采用主角有限视角，只写主角当场能看见、听见或后来获知的内容；旁观时的无力感可以强化残忍，但不得借灵魂身份切成全知叙述。
...
### 视角数量控制
- 全文固定单一主角限知视角，默认第一人称；用户要求第三人称时也只紧贴主角
- 不插渣男、白月光、反派或旁观者视角，不直接写他人内心和主角无来源的场外事件
- 他人信息只能由主角亲历、听见、读到，或后来从明确来源得知；推断必须保留主角认知边界
...
- [ ] 全文只有单一主角限知视角，每条重要信息都有主角可接触的来源？
- [ ] 对话占正文不超过 35%，每句对话推动剧情、关系或情绪？
